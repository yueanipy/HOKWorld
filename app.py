...
from PySide6.QtGui import QCursor, QDrag, QFontMetrics, QIcon
...
from qfluentwidgets import (
    ...
    InfoBadge,
    IndeterminateProgressRing, MenuAnimationType, MessageBoxBase, NavigationItemPosition, PrimaryPushButton,
    ProgressBar, PushButton,
    PushSettingCard, SettingCard, SingleDirectionScrollArea, SpinBox, StrongBodyLabel,
    SubtitleLabel, SwitchButton, SwitchSettingCard, TextEdit, ToolButton,
    TitleLabel, LineEdit, isDarkTheme, setTheme, setThemeColor, Theme,
)
...
class MainWindow(FluentWindow):
    ...
    def __init__(self) -> None:
        ...
        self.stackedWidget.currentChanged.connect(self._sync_combat_hotkey_scope)
        self._sync_combat_hotkey_scope()
    ...
    def _on_key(self, key) -> None:
        ...
        try:
            if key == keyboard.Key.f11 and self._combat_hotkeys_enabled.is_set():
                now = time.monotonic()
    ...
    def _sync_combat_hotkey_scope(self, *_args) -> None:
        '只在自动战斗菜单为当前页面时启用 F11。'
